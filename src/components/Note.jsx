...
export default function Note({title,description,id,handleDeleteNotes}){   
    ...
    return (
        <>
        <div onClick={openModal} className='note-container flex flex-col items-center rounded-xl justify-around border-2 border-black hover:scale-110 duration-200 bg-white text-amber-400 p-5 m-10   '>
